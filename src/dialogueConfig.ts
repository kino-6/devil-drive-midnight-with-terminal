...
export const defaultDialogueConfig: DialogueConfig = {
  ...
  lines: {
    ...
    'moe.story.boss_preview_log01': '深層関門の反応、前よりは読める。通行料を払う相手を間違えないで。',
    ...
    'moe.run.boss_preview': '関門級の強い反応。無理なら引き返そ。',
    'moe.run.boss_preview.1': '深層関門、反応強い。強がるのは好きだけど、車は正直だよ。',
    'moe.run.boss_start': '深層関門、突入。主砲を温存しすぎないで。',
    ...
    'moe.run.abyss_cleared': 'Abyss Loop突破。Stage4解放じゃない、ここが終点。報酬を積んで戻ろう。',
    ...
    'moe.garage.boss_tip': '関門級の強い反応。主砲弾かS-E弾、どっちかは残しておきたいね。',
